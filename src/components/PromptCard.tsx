...
export const IdeaCard: React.FC<IdeaCardProps> = ({ 
  ...
  const getContainerClasses = () => {
    const baseClasses = "fixed inset-0 flex items-center justify-center p-4 sm:p-6 z-50 transition-all duration-500 ease-out";
  ...
  const getCardClasses = () => {
    const baseClasses = "w-full max-w-sm sm:max-w-lg transition-all duration-700 ease-out";
